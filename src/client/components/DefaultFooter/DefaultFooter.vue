    ...
    <div class="container mx-auto px-6">
      <div class="flex justify-between items-center mb-6">
        <div class="flex items-center">
          <img alt="Fitty logo" class="h-28" src="../../../shared/assets/fittyPNG.png" />
        </div>
      ...
      <div class="flex justify-between items-center">
        ...
        <div class="flex space-x-4">
          ...
          <a class="text-gray-600" href="#"> Terms </a>
          <a class="text-gray-600" href="#"> Pricing </a>
          <a class="text-gray-600" href="#"> Do not sell or share my personal information </a>
        </div>
      </div>
    </div>
  </div>
